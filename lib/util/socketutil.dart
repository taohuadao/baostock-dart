...
class SocketUtil {
    ...
    //     :return:
    //     """
    void send_data(Socket socket, data) {
        socket.write(data);
    }
    ...
    //     :return:
    //     """
    String send_and_receive_data(Socket socket, data) {
        SocketUtil.send_data(socket, data);
        String return_data = SocketUtil.receive_data(socket);
        return return_data;
    }
    ...
    //     :return:
    //     """
    String send_and_receive_data_default(data) {
        Socket socket = SocketUtil.get_default_socket();
        String return_data = SocketUtil.send_and_receive_data(socket, data);
        return return_data;
    }
    ...
    //     :return:
    //     """
    String send_and_receive_data_default_zlib(data) {
        Socket socket = SocketUtil.get_default_socket();
        String return_data = SocketUtil.send_and
    }
